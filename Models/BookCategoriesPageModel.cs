...
namespace Barsan_RoxanaElena_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Barsan_RoxanaElena_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Barsan_RoxanaElena_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
